...
module.exports = {
    ...
    connect: function (client) {
        ...
        print(cct.cn("connect(") + cct.value(cp.database) + cct.cn(")"));
    },
    ...
    disconnect: function (client) {
        ...
        print(cct.cn("disconnect(") + cct.value(cp.database) + cct.cn(")"));
    },
    ...
    transact: function (e) {
        ...
        if (typeof(e.ctx.tag) === 'string') {
            msg += cct.tx("(") + cct.value(e.ctx.tag) + cct.tx(")");
        }
        if (e.ctx.finish) {
