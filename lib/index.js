...
var monitor = {
    ...
    error: function (err, e, detailed) {
        ...
        if (e.ctx && (monitor.detailed || detailed)) {
            var sTag = getTagName(e);
            if (sTag) {
                print(timeGap + cct.paramVerb("tx(") + cct.value(sTag) + cct.paramVerb("): ") + cct.value(q), true);
            } else {
                print(timeGap + cct.paramVerb("tx: ") + cct.value(q), true);
            }
        } else {
            print(timeGap + cct.paramVerb("query: ") + cct.value(q), true);
        }
